...
namespace UwpSample.Views
{
    ...
    public sealed partial class SystemMediaPlayerPage : Page
    {
        ...
        private SystemMediaPlayerPage rootPage = null;
        ...
        public SystemMediaPlayerPage()
        {
            ...
            Current = this;
            SampleTitle.Text = "System Media Transport Controls C# Sample";
        }
        ...
        private async void systemMediaControls_AutoRepeatModeChangeRequested(SystemMediaTransportControls sender,
        ...
        /// </summary>
        private async void systemMediaControls_PlaybackPositionChangeRequested(SystemMediaTransportControls sender,
        ...
        /// </summary>
        private async void systemMediaControls_PlaybackRateChangeRequested(SystemMediaTransportControls sender,
